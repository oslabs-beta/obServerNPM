...
function Layer(path, options, fn) {
  if (!(this instanceof Layer)) {
    // observer.stack.push(new Layer(path, options, fn))
...
//         observer.newStack.push(existingMiddleware)
//         observer.newStack.push(ourMiddleware)
//       })
//       layer.route.stack = observer.newStack
//     }
//   })
