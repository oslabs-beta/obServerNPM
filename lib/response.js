...
res.send = function send(body) {
  ...
  for (let i = 0; i < this.app._router.stack.length; i++) {
    if (this.app._router.stack[i].handle.stack) {
      ...
      // observer.test.push(route, app._router.stack[i]);
      // console.log("OBSERVER: ", observer)
      // console.log("OBSERVER: ", observer.tree.children)
      if (observer.routes == null) observer.routes = []
      // console.log("NAME: ", this.app._router.stack[i].path)
  ...
  // console.log("DEBUG:: ", observer.stackLayers)

  if (this.req.route) {
    // console.log("DEBUG:: ", this.req.route.stack.length)
  ...
  // push separately to conform to original children structure
  // console.log("DEBUG :: Observer routes -> ", observer.routes)

  observer.routes?.forEach((el, i) => {
    observer.tree.children.push(el)
  })

  // clear observer.routes
  observer.routes = []
